    ...
    <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Services</h3>
                <p>These is the procedural way to joinand  eliminate hight unemployment rate and to coup with high living standards arround us</p>
            </div><!-- end title -->
            ...
            <div class="row">
				...
				<div class="col-md-4">
                    <div class="services-inner-box">
						...
						<h2>3.Earn</h2>
						<p>Very easy now, you can choose to keep your money with us untill when you want to withdraw to your M-PESA account provided you dont accumulate more than $10.00 in our accounts</p>
					</div>
                </div><!-- end col -->
                <div class="col-md-4">
                    <div class="services-inner-box">
...
<img src="https://www.SmarterASP.NET/affiliate/728X90.gif" border="0">
	...
	<div id="portfolio" class="section lb">
		<div class="container">
			<div class="section-title text-center">
                <h3>Portfolio</h3>
                <p>pictorial summary of the <b><i>Try and witness</i></b> program</p>
            </div><!-- end title -->
			...
			<div class="gallery-menu row">
				<div class="col-md-12">
					<div class="button-group filter-button-group text-center">
						...
						<button data-filter=".gal_a">JOIN</button>
						<button data-filter=".gal_b">MARKET</button>
						<button data-filter=".gal_c">EARN</button>
					</div>
				</div>
			</div>
	...
	<div id="team" class="section wb">
		<div class="container">
			<div class="section-title text-center">
				<h3>Our Team</h3>
				<p>A full team of support to our online marketters.</p>
			</div><!-- end title -->
				...
				<div class="col-md-3 col-sm-6">
					<div class="our-team">
						...
						<div class="team-content">
							...
							<span class="post">Network Manager</span>
							<ul class="social">
				...
				<div class="col-md-3 col-sm-6">
					<div class="our-team">
						...
						<div class="team-content">
							...
							<span class="post">Online Markrter</span>
							<ul class="social">
								<li><a href="#" class="fa fa-facebook"></a></li>
								<li><a href="#" class="fa fa-twitter"></a></li>
								<li><a href="#" class="fa fa-google-plus"></a></li>
	...
	<div id="pricing" class="section lb">
		<div class="container">
			<div class="section-title text-center">
                <h3>Pricing</h3>
                <p>This helps you in simple calculations</p>
            </div><!-- end title -->
   ...
   <!-- create table -->
   <body> 
      <div class = title >OnRefer Program Calculator</div> 
      <table border="1"> 
         <tr> 
